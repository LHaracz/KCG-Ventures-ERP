...
export default function PackagePresetsPage() {
    ...
    <AuthGuard>
      <div className="mx-auto max-w-3xl space-y-6">
        <header>
          ...
          <h1 className="mb-1 text-2xl font-semibold text-zinc-900">Package Presets</h1>
          <p className="text-sm text-zinc-600">
            Reusable box dimensions and tare weight, used to compute parcel weight on the
            Fulfillments order pages and to pre-fill the Generate Label popup.
          </p>
        </header>
        ...
        <section className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
          <div className="grid gap-4 md:grid-cols-2">
            <form onSubmit={handlePresetSubmit} className="space-y-2 text-xs">
              ...
              <div>
                <label className="mb-1 block font-medium text-zinc-800">Tare weight (oz)</label>
                <input
                  required
                  type="number"
                  step="0.01"
                    ...
                    >
                      <div>
                        ...
                        <div className="text-[11px] text-zinc-600">
                          {p.length_in}×{p.width_in}×{p.height_in} in · {p.tare_weight_oz} oz tare
                        </div>
                      </div>
